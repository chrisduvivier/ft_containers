...
int main()
{
...

	{
		...
		typedef std::vector<std::pair<int, std::string> >::iterator vector_iter;
		...
		number.insert (std::make_pair(1,"one"));
		number.insert (std::make_pair(2,"two"));
		number.insert (std::make_pair(3,"three"));
